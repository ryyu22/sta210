...
The probability of being satisfied seems highest for middle age (groups aged 41-50 and 51-60) people while younger and older passengers have a smaller probability of being satisfied. There is a notable difference in the proportion of satisfied passengers between age groups with a sharp drop off once the passenger age reaches 60 years old. Since there is an obvious non-linear relationship between individual ages, the ages were grouped into categories for our analysis.
...
My research is potentially limited by the fact that the data was collected through a survey, with a subjective rating system of the different factors and overall satisfaction. Everyone has different preferences and weigh each aspect of their experience differently when it comes to determining overall satisfaction. Additionally, the people responding to the survey chose to respond. The demographic of people that declined or ignored responding to the survey could be different than the people who did respond, which could potentially skew the results. To correct this, we could try to determine more objective methods of determining satisfaction and improve our sampling methods. There are also potential issues with colinearity which can be seen with correlated predictors. For example, people with worse legroom are also more likely to be on a worse airline that will offer worse onboard service. 
